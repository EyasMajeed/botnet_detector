...
_Generated_: `2026-05-10T17:21:37.277962Z`
...
- **ST-2b — End-to-end throughput**  _(theme: Throughput — end-to-end with XAI)_
    ...
    - actual:   end-to-end only 65 pps (ingest is fine at 39346 pps, but flush of 10000 flows took 153.6s = 65 flow/s). The bottleneck is flow finalisation: Stage-2 inference + per-flow XAI.
...
**Slowest 5 tests:**
- M-ADV Scaler-aware adversarial perturbation: 409.4s
- ST-2b End-to-end throughput: 155.8s
- SC-K Kitsune key explosion: 145.1s
- ST-1 Large PCAP throughput: 110.7s
- SE-A SYN flood: 69.0s

**Top 5 by peak RSS:**
- ST-1 Large PCAP throughput: 2187 MB
- SC-K Kitsune key explosion: 671 MB
- ST-3 Long-duration monitoring: 574 MB
- ST-4 Concurrent uploads: 564 MB
- ST-2b End-to-end throughput: 552 MB
